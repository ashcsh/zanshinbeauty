  ...
  return (
    <div ref={scrollRef} className={container[layout]}>
      <section className="grid gap-6">
        <Text format>
          Se pare ca nu ati adaugat inca niciun produs. Apasati mai jos pentru a continua.
        </Text>
        <div>
          <Button onClick={onClose}>Continua Cumparaturile</Button>
        </div>
      </section>
...
export default function TopProducts({onClose}) {
  ...
  if (products.length === 0) {
    return <Text format>Nu au fost gasite produse.</Text>;
  }
