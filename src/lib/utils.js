...
export function statusMessage(status) {
  const translations = {
    ATTEMPTED_DELIVERY: 'A Incercat sa se livreze',
    CANCELED: 'Anulata',
    ...
    MARKED_AS_FULFILLED: 'Onorata',
    NOT_DELIVERED: 'Nelivrata',
    ON_HOLD: 'On Hold',
    OPEN: 'Deschisa',
    OUT_FOR_DELIVERY: 'La Curier',
    PARTIALLY_FULFILLED: 'Onorata Partial',
    PENDING_FULFILLMENT: 'In Procesare',
    PICKED_UP: ' A fost Ridicata',
    READY_FOR_PICKUP: 'Gata de ridicare',
    RESTOCKED: 'Restocked',
    SCHEDULED: 'Programata',
    SUBMITTED: 'Submitted',
    UNFULFILLED: 'Neprocesata',
  };
  try {
