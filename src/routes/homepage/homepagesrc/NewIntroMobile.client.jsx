...
export default function NewIntroMobile({ bestSeller, nodes }) {
    ...
    return (
        <div className=" w-full h-max bg-[#F0F5F9] flex flex-col justify-between">
            <div className="h-max w-full flex flex-col items-center justify-between relative">

                <div className="w-[95%] h-[40vh] bg-[#F0F5F9] imgReveal invisible absolute top-0 left-0 z-40">
                </div>
                ...
                <div className="mainhero invisible w-[95%] h-[35vh] flex flex-col items-center justify-start z-30 mt-[50px]">
                    ...
                    <div className="flex flex-col z-20 w-max h-max items-center ">
                        ...
                        <div className="flex items-center justify-center text-[30px] font-['Kenjo'] mt-[50px] tracking-[0.25em]  text-[#1E2022] phoneone:text-[20px] galaxyfold:text-[15px]" >
                            ...
                            <h3 className="zanshintextmain invisible">N</h3>
                            <h3 className="zanshintextmain invisible ml-[15px] galaxyfold:ml-[10px]">B</h3>
                ...
                <div className="swimlane invisible w-full h-max flex flex-col items-center jusitfy-center shadow-md  mt-[60px]">
                        <h6 className="self-start text-[10px]">Cele mai vandute produse</h6>
                ...
                <div className="h-max w-full absolute top-10 flex flex-col items-center justify-center">

                    <svg
                        id="mlogo"
                        className="w-2/6 max-w-[130px] invisible mt-[50px] "
                        data-name="Layer 2"
                    ...
                    <div className="flex flex-col items-center justify-center text-[35px]">
                        <h3 className="mzanshintext invisible font-['Kenjo'] text-[#1E2022]">
                            Z
                        </h3>
                        <h3 className="mzanshintext invisible font-['Kenjo'] text-[#1E2022]">
                            A
            ...
            // }}
                ...
                <div className=" w-full h-1/2 flex items-end justify-center relative mb-[30px]">
                    <div className=" p-10 mr-5 w-max h-[200px] mt-[-100px] absolute top-[50%] left-0   text-[#52616B] font-serif text-[20px] cursor-pointer flex flex-col items-center justify-center galaxyfold:text-[10px] galaxyfold:mr-[0px] ">
                        <h3 className="mcolectii shadow-lg">C</h3>
                        <h3 className="mcolectii shadow-lg">O</h3>
                        <h3 className="mcolectii shadow-lg">L</h3>
                        <h3 className="mcolectii shadow-lg">E</h3>
                        <h3 className="mcolectii shadow-lg">C</h3>
                        <h3 className="mcolectii shadow-lg">T</h3>
                        <h3 className="mcolectii shadow-lg">I</h3>
                        <h3 className="mcolectii shadow-lg">I</h3>
                    </div>
                    <div className=" w-3/5  flex flex-col h-full items-center justify-center galaxyfold:ml-[-30px]">


                        <div className="mcreme flex flex-col justify-center items-center group h-auto w-full">
                            <div className="w-max h-max flex items-center relative">
                                <div className="  cursor-pointer w-[90px] h-[90px] flex items-center justify-center rounded-full bg-[#52616B] shadow-lg group-hover:scale-[1.2] duration-700 galaxyfold:w-[78px] galaxyfold:h-[78px]">
                                    <img className=" w-[85px] h-[85px] bg-[#C9D6DF] rounded-full galaxyfold:w-[75px] galaxyfold:h-[75px]" src={hidratare} alt="ColectieHidratareTen" />
                                </div>
                                <button className="mcremeb invisible absolute h-max text-[15px]  font-[serif] shadow-lg p-[8px] hover:shadow-xl galaxyfold:text-[10px] "> Creme & Serumuri </button>
                            </div>
                        </div>


                        <div className="mcleansere flex flex-col justify-center items-center group h-auto w-full  my-[30px] ">
                            <div className="w-max h-max flex items-center relative">
                                <button className="mcleansereb h-max invisible absolute text-[15px] font-[serif] shadow-lg p-[8px] hover:shadow-xl galaxyfold:text-[10px]">Cleansere</button>
                                <div className=" cursor-pointer w-[90px] h-[90px] flex items-center justify-center rounded-full bg-[#52616B] shadow-lg group-hover:scale-[1.2] duration-700 galaxyfold:w-[78px] galaxyfold:h-[78px] galaxyfold:ml-[-5px]">
                                    <img className="w-[85px] h-[85px] bg-[#C9D6DF] rounded-full galaxyfold:w-[75px] galaxyfold:h-[75px]" src={curatare} alt="ColectieHidratareTen" />
                                </div>
                            </div>
                        </div>


                        <div className="mmasti flex flex-col bmasti justify-center items-center group h-auto w-full ">
                            <div className="w-max h-max flex items-center relative">
                                <div className=" cursor-pointer w-[90px] h-[90px] flex items-center justify-center rounded-full bg-[#52616B] shadow-lg group-hover:scale-[1.2] duration-700 galaxyfold:w-[78px] galaxyfold:h-[78px] ">
                                    <img className=" w-[85px] h-[85px] bg-[#C9D6DF] rounded-full galaxyfold:w-[75px] galaxyfold:h-[75px]" src={masti} alt="ColectieHidratareTen" />
                                </div>
                                <button className="mmastib h-max invisible absolute text-[15px] font-[serif] shadow-lg p-[8px] hover:shadow-xl galaxyfold:text-[10px] ">Masti Faciale</button>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div className="h-max   w-full  flex flex-col items-center justify-center z-20">
                <motion.a whileTap={{ scale: 0.9 }} href="/products/pyunkang-yul-calming-moisture-barrier-cream" className="w-max h-max cursor-pointer ">
                    <div className="h-max w-max">
                        <img className="w-[80vw] h-max shadow-lg" src={bannerStanga} alt="zanshinBanner" />
                    </div>
                </motion.a>
                <img className="w-[40vw] my-[5vw]"  src={bannerLogo} alt="zanshinBanner" />
                <motion.a whileTap={{ scale: 0.9 }} href="/products/jumiso-all-day-vitamin-brightening-balancing-serum" className="w-max h-max cursor-pointer  ">
                    <div className="h-max w-max">
                        <img className="w-[80vw] h-max shadow-lg" src={bannerDreapta} alt="zanshinBanner" />
                    </div>
                </motion.a>
            </div>
...
{/* <div>
<a whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.9 }} className="underline p-2 font-bold cursor-pointer ">Livrari si Retururi</a>
<a whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.9 }} className="underline p-2 font-bold cursor-pointer ">Termeni si Conditii</a>
<a whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.9 }} className="underline p-2 font-bold cursor-pointer ">Politica de Confidentialitate</a>
<a whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.9 }} className="underline p-2 font-bold cursor-pointer ">ANPC</a>
<img className="w-[80px] h-[30px] ml-[5px]" src={stripe} alt="stripe" />
<img className="w-[80px] h-[30px] mr-[5px]" src={anpc} alt="anpc" />
<img className="mmail invisible w-[30px] h-[30px] " src={mail} alt="mail" />
                    <img className="minstagram invisible w-[30px] h-[30px] " src={instagram} alt="instagram" />
                    <img className="mtelefon invisible w-[30px] h-[30px] " src={phone} alt="telefon" />
</div> */}